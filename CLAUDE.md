...
- **`.claude/tempo-project.yaml`** — repo→project binding (`project.name: tokenops`); resolves through the central `~/source/repos/tempo/config/tempo.yaml` `repoRoots` chain.
